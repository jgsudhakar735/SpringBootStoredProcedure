...
@Service
@Log4j2
public class DefaultAbstractProceImpl extends AbstractProcImpl{

    public DefaultAbstractProceImpl(DataSource dataSource) {
        super(dataSource);
    }
    ...
    public Response processOutPut(Map<String, Object> output) {
        log.info("Procedure Invoked and processing the Out Data");
